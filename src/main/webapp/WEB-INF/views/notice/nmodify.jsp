	...
	<section>
		...
		<table width="1000">
			<form action="nmodify" method="post">
				<input type="hidden" name="nNo" value="${modifyView.nno }">
				<colgroup>
	        		<col width="10%" />
	        		<col width="90%" />
	        	</colgroup>
	        	<tr>
					<td class="left">제목</td>
					<td class="right"><input type="text" name="nTitle" size="118"
						value="${modifyView.ntitle }"></td>
				</tr>
				<tr>
					<td class="left">내용</td>
					<td class="right"><textarea name="nContent" rows="15" cols="140">${modifyView.ncontent }</textarea></td>
				</tr>
				<tr style="text-align:center">
					<td colspan="2"><input id="btn_01" type="submit" value="수정완료"><a
						id="btn_c" href="ncontent-view?nNo=${modifyView.nno }">취소</a></td>
				</tr>
			</form>
		</table>
	</section>

	...
	<section>
		...
		<table width="1000">
			<form action="modify" method="post">
				<input type="hidden" name="hNo" value="${modifyView.hhhno }">
				<colgroup>
	        		<col width="10%" />
	        		<col width="90%" />
	        	</colgroup>
	        	<tr>
					<td class="left">제목</td>
					<td class="right"><input type="text" name="hTitle" size="118"
						value="${modifyView.hhhtitle }"></td>
				</tr>
				<tr>
					<td class="left">내용</td>
					<td class="right"><textarea name="hContent" rows="15" cols="140">${modifyView.hhhcontent }</textarea></td>
				</tr>
				<tr style="text-align:center">
					<td colspan="2"><input id="btn_01" type="submit" value="수정완료"><a
						id="btn_c" href="content-view?hNo=${modifyView.hhhno }">취소</a></td>
				</tr>
			</form>
		</table>
	</section>

	    	...
	    	<div id="content">
				...
				<form action="join" method="post">
					<dl>
						...
						<span id="idEl" style="font-style:italic; color:red;">&nbsp;&nbsp;${idDupl }</span></dd>
					</dl>
					<dl>
						<dt>비밀번호 입력<span> ※ </span></dt>
						<dd><input type="password" name="pw1" id="pw1" size="35" class="validate required" /><br>
						영문(대,소구별),숫자,특수문자 조합<br>
						8~12자</dd>
					</dl>
					<dl>
						<dt>비밀번호 확인<span> ※ </span></dt>
						<dd><input type="password" name="pw2" id="pw2" size="35" class="validate required" /></dd>
					</dl>
					<dl>
						<dt>사용하실 닉네임<span> ※ </span></dt>
						<dd><input type="text" name="nickname" id="nickname" size="35" class="validate required" /><br>
						2~8자<br>
						<span id="nnEl" style="font-style:italic; color:red;">&nbsp;&nbsp;${nnDupl }</span></dd>
					</dl>
					<dl>
						<dt>이메일 입력<span> ※ </span></dt>
						<dd><input type="text" name="email" id="email" size="35" class="validate required" /></dd>
					</dl>
					<p style="text-align:center"><input class="btn" type="submit" value="확인" />

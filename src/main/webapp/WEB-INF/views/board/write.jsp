...
<div id="wrap">
    ...
    <section>
        ...
        <table width="1000">
			...
			<input type="hidden" name="hName" value="${memberNickname }">
				<colgroup>
	        		<col width="10%" />
	        		<col width="90%" />
	        	</colgroup>
				...
				<tr>
					<td class="left">제목</td>
					<td class="right"><input type="text" name="hTitle" size="118"></td>
				</tr>
				<tr>
					<td class="left">내용</td>
					<td class="right"><textarea name="hContent" rows="15" cols="140" ></textarea></td>
				</tr>
				<tr style="text-align:center">
					<td colspan="2">
						<input id="btn_01" type="submit" value="작성완료">&nbsp;<a id="btn_c" href="board">취소</a>
					</td>
				</tr>
			</form>
		</table>
